      ...
      <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class=" px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
            ...
            <div class="-mx-3 md:flex mb-6">
              <div class="md:w-full px-3">
                ...
                <div class="flex w-full items-center justify-center bg-grey-lighter">
                  <label class="w-ful flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:text-black">
            ...
            <button 
              type="submit"
              class="flex items-center uppercase font-center sm:w-1/6 p-2 bg-gray-800 hover:bg-gray-700 text-sm space-y-2 text-white rounded-md"
              >
              Crear
            </button>
