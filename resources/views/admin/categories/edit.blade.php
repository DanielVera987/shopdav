<x-app-layout>
  ...
  <div class="flex flex-col flex-1 h-full overflow-hidden">
      ...
      <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
        <h3 class="mt-6 text-xl">Editar Categoria</h3>
          ...
          <div class=" px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
            ...
            <div class="-mx-3 md:flex mb-6">
              <div class="md:w-full px-3">
                ...
                <input 
                  class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter @if($errors->has('description')) border-red-500 @endif rounded py-3 px-4 mb-3" 
                  type="text" 
                  name="description"
                  id="description" 
