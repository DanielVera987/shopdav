  ...
  <div class="flex flex-col flex-1 h-full overflow-hidden">
      ...
      <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
        ...
        <div class="flex justify-between">
          ...
          <h3 class="flex items-centermt-6 text-xl">Lista de Cupones</h3>
          
          <a href="{{ route('admin.coupons.create') }}" class="flex items-center p-2 bg-gray-800 hover:bg-gray-700 text-sm space-y-2 text-white rounded-md">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      @foreach ($coupons as $coupon)                        
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="flex items-center">      
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">{{ $coupon->active }}</div>
                            </div>
                          </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
