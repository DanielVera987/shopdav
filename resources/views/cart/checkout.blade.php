    ...
    <div class="my-6">
      <div class="flex flex-col w-full p-8 text-gray-800 bg-white pin-r pin-y">
        <div class="flex-1">
          ...
          <input type="hidden" id="porcent_coupon" value="">
                ...
                <div class="justify-center md:flex">
                  {{-- <form action="" method="POST"> --}}
                      <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                        <input type="coupon" id="coupon" placeholder="Aplicar Cupon" value=""
                                class="w-full bg-gray-100 outline-none appearance-none focus:outline-none active:outline-none"/>
                          <button type="botton" id="btn-coupon" class="text-sm flex items-center px-3 py-1 text-white bg-gray-800 rounded-full outline-none md:px-4 hover:bg-gray-700 focus:outline-none active:outline-none">
            ...
            <div class="lg:px-2 lg:w-1/2">
              ...
              <div class="p-4">
                <p class="mb-6 italic">Los costos de envío y adicionales se calculan en función de los valores ingresados</p>
                  ...
                  <div class="flex justify-between pt-4 border-b hidden lbl_coupon">
                    <div class="flex lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-gray-800">
                      <form action="" method="POST">
                        <button type="button" id="delete_coupon" class="mr-2 mt-1 lg:mt-2">
                      ...
                      Cupon "<span class='name_coupon'></span>"
                    </div>
                    <div class="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-green-700 total_coupon">
                      
                    </div>
                  </div>
                  <div class="flex justify-between pt-4 border-b hidden lbl_new_subtotal">
                    <div class="lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-center text-gray-800">
                      Nuevo Subtotal
                    </div>
                    <div class="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-gray-900 total_new_subtotal">
                      14,882.75€
                    </div>
                  </div>
