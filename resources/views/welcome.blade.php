            ...
            <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
                ...
                <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="hero-text col-span-6">
                        <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Ecommerce ShopDav</h1>
                        <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8">
                        <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold">Una Tienda en linea desarrollada con Laravel y Tailwind. Por Daniel Vera con ❤</p>
                        <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start">
                            <button class="apple bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                                <div class="text">
                                    <p class=" text-xs font-semibold text-gray-900">Inicar Sesión</p>
                                </div>
                            </button>
                            <button class="google bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                                <div class="text">
                                    <p class="text-xs font-semibold text-gray-900">Registrarse</p>
                                </div>
                            </button>
                        </div>
                    </div>
            ...
            <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                ...
                <nav id="store" class="w-full z-30 top-0 px-6 py-1">
                    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                        ...
                        <a class="uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl " href="{{ route('categories.index') }}">
                            Categorias
                        </a>
                ...
                <div class="w-full md:w-2/4 xl:w-2/4 px-4 flex flex-col">
                    <a href="#">
                        <p class="text-white uppercase font-bold relative top-10 z-10 pt-3 text-center">{{ $category->name }}</p>
                        <img class="hover:grow hover:shadow-lg hover:bg-black hover:opacity-50" src="{{ $category->image ?? 'https://placeimg.com/640/480/any' }}">
                    </a>
                </div>
                @endforeach
