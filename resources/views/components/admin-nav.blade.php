...
<header class="flex-shrink-0 border-b">
  <div class="flex items-center justify-between p-2">
      ...
      <div class="flex items-center space-x-3">
        <span class="p-2 text-xl font-semibold tracking-wider uppercase lg:hidden">{{ config('app.name', 'SHOPDAV') }}</span>
      ...
      <div class="relative" x-data="{ isOpen: false }">
          ...
          <div class="flex items-center justify-center p-4 text-blue-700 z-40 underline border-t">
